...
# Try importing audio module safely
try:
        ...
        with st.spinner("Analyzing... Please wait"):
            ...
            if AUDIO_AVAILABLE:
                try:
                    ...
                    sentiment = 50
                    st.warning("Audio analysis failed. Using default value.")
            else:
                sentiment = 50
                st.info("Audio module not available in deployment. Using default value.")
